...
\newcommand{\acronym}[1]{\textsc{\fontspec[Numbers={OldStyle},Ligatures=TeX]{Libertinus Serif}\MakeLowercase{#1}}}
\newcommand{\uppersc}[1]{{\fontspec[Letters=UppercaseSmallCaps,Ligatures=TeX]{Libertinus Serif}#1}}
